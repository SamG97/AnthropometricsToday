...
collegeMen = ['Christ\'s', 'Clare', 'Corpus Christi', 'Downing', 'Emmanuel',
              'Fitzwilliam', 'Gonville & Caius', 'Jesus', 'King\'s',
              'Magdalene', 'Pembroke', 'Peterhouse', 'Queen\'s', 'Selwyn',
              'Sidney Sussex', 'St Catharine\'s', 'St Edmund\'s',
              'St John\'s', 'Trinity', 'Trinity Hall']
MenWeights = [541 / 12717, 655 / 12717, 467 / 12717, 623 / 12717, 750 / 12717,
              688 / 12717, 719 / 12717, 704 / 12717, 581 / 12717,
              493 / 12717, 597 / 12717, 370 / 12717, 832 / 12717, 630 / 12717,
              506 / 12717, 621 / 12717, 499 / 12717,
...
with open('fakedata.csv', 'w') as fw:
    fw.write(
        "DoB_month" + ',' + "DoB_day" + ',' + "DoB_year" + ',' + "Age" + ',' + "Name" + ',' + "College" + ',' + "Sex" + ',' + "Eye_Colour" + ',' +
    ...
    for _ in range(10000):
        ...
        data = str(DoB_month) + ',' + str(DoB_day) + ',' + str(
            DoB_year) + ',' + str(
            Age) + ',' + Name + ',' + College + ',' + Sex + ',' + Eye_Colour + ',' + Hair_Colour + ',' + str(
            Head_length) + ',' + str(Face_breadth) + ',' + str(Face_iobreadth)
        fw.write(data)
        fw.write('\n')
fw.close()
